    ...
    <div>
      <div className="flex flex-col border border-gray-100 lg:flex-row  bg-white overflow-hidden">
        <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-8 w-full lg:w-1/2 '>
          <h1 className='text-slate-700 font-bold text-5xl'>
        ...
        <div className='w-full lg:w-1/2 flex flex-col justify-center bg-no-repeat bg-cover bg-center' 
        style={{
      ...
      <div className="bg-gray-100 p-10 py-12 flex flex-col gap-5 w-full lg:flex-row overflow-hidden">
        ...
        <div className="flex bg-white lg:w-1/2 mx-4 shadow-lg h-72 hover:scale-105 transition-scale duration-300">
          ...
          <div className='w-full lg:w-1/2 flex flex-col  bg-no-repeat bg-cover bg-center ' 
          style={{
